...
const ListView = ({ events, waitlist }: Props) => {
  return (
    <div className="pl-5 pr-1 h-full gap-3 overflow-y-scroll gray-scrollbar">
      <div className="w-full pt-5 z-10 bg-white">
        <h3 className="pt-2 text-2xl font-semibold text-cardtitle font-title">
          Your Courses
        </h3>
      ...
      <div className="flex flex-col gap-5 pb-6">
        <h3 className="py-2 pb-4 text-2xl font-semibold text-cardtitle font-title">
          Enrolled
        </h3>
        {events?.map(
          ({
